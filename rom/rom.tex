...
\tssec{Linje i rommet}\index{linje}\index{parameterisering! av linje}
...
\liro
\liroe
\tssec{Plan i rommet}\index{plan}\index{parameterisering!av plan}
...
\fig{vegg}{$ x $ og $ y $ bortover langs veggene, $ z $ rett opp. Gulvet er et utklipp av $ xy $-planet.}
...
\fig{plan}{Utklipp av planet $ \alpha $ utspent av vektorene $ \vec{v} $ og $ \vec{u} $.}
...
\tssec{Ligningen til et plan}\index{plan!ligningen til}
En mer kompakt metode enn parameterisering er å beskrive et plan ved en ligning. 
\fig{surf1}{Punktene $ {A=(x_0, y_0, z_0)} $ og $ {B=(x, y, z)} $ i planet $ \alpha $ med normalvektor $ {\vec{n}=[a, b, c]} $.}
...
\fig{plskj}{Skjæringslinje mellom to plan.\label{plskj}}
\limtpl
\newpage
\eks{
...
\tssec{Avstand mellom punkt og linje}\index{avstand!fra punkt til linje}
...
\fig{plin}{Punkt $ B $ en avstand $ h $ fra linja $ l $. \label{plin}}
...
\tssec{Avstand mellom punkt og plan}\index{avstand!fra punkt til plan}
...
\fig{pplan}{Den korteste avstanden $ h $ mellom punktet $ A $ og planet (i blått).}
\avplp
...
\begin{figure}
		\centering
	\subfloat[a)]{\includegraphics[]{\asym{vinkell}}}\,
	\subfloat[b)]{\includegraphics[]{\asym{vinkellb}}}
...
\begin{figure}
	...
	\centering
	\subfloat[\textsl{a)}]{\includegraphics[]{\asym{vinkelpl}}}
	\qquad\quad
	\subfloat[\textsl{b)}]{\includegraphics[]{\asym{vinkelplb}}}
...
\begin{figure}
		\centering
	\subfloat[\textsl{a)}]{\includegraphics[]{\asym{vinkel}}}
	\qquad\quad	
	\subfloat[\textsl{b)}]{\includegraphics[]{\asym{vinkelb}}}	
...
\subsection*{Avstanden mellom punkt og plan}
\vs
\begin{figure}
	\centering
